  ...
  const rows = top
    .map(
      ...
      <tr>
        ...
        <td style="padding:8px;border-bottom:1px solid #2a2f3a;font-weight:bold;">${r.price} ${r.currency}${r.originalPrice != null ? `<br><span style="font-weight:normal;font-size:11px;color:#888;">${r.originalPrice} ${r.originalCurrency}</span>` : ""}</td>
